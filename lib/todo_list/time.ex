defmodule TodoList.Time do
  ...
  """
  def get_working_time_by_user_id(user_id, start_date \\ nil, end_date \\ nil) do
    query =
  ...
  ## Examples
      ...
      iex> get_working_time_by_id!(123)
      %WorkingTime{}

      iex> get_working_time_by_id!(456)
      ** (Ecto.NoResultsError)
